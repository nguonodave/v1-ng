"""
Django settings for nguonodave project.
...
SECRET_KEY = 'django-insecure-k7gxwv$s=zp132^n&ls=1v*sqv)h#igj(mu+*j$7g+=4s*t$qf'
...
INSTALLED_APPS = [
    ...
    "projectCategories.apps.ProjectcategoriesConfig",
    "workExperience.apps.WorkexperienceConfig",
    "placesOfWork.apps.PlacesofworkConfig",
...
WSGI_APPLICATION = 'nguonodave.wsgi.application'
